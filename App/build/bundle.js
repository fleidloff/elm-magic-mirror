...
Elm.Elm = Elm.Elm || {};
Elm.Elm.Model = Elm.Elm.Model || {};
Elm.Elm.Model.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Model = _elm.Elm.Model || {};
   if (_elm.Elm.Model.values) return _elm.Elm.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var model = {time: 0.0,weather: {temp: 0.0,sunrise: 0,sunset: 0,name: ""},froodle: "",birthdays: ""};
   var Weather = F4(function (a,b,c,d) {    return {temp: a,sunset: b,sunrise: c,name: d};});
   var Model = F4(function (a,b,c,d) {    return {time: a,weather: b,froodle: c,birthdays: d};});
   return _elm.Elm.Model.values = {_op: _op,Model: Model,Weather: Weather,model: model};
};
Elm.Elm = Elm.Elm || {};
Elm.Elm.Actions = Elm.Elm.Actions || {};
Elm.Elm.Actions.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Actions = _elm.Elm.Actions || {};
   if (_elm.Elm.Actions.values) return _elm.Elm.Actions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "Run": return {ctor: "_Tuple2",_0: model,_1: _p0._0};
         case "UpdateTime": return {ctor: "_Tuple2",_0: _U.update(model,{time: _p0._0}),_1: $Effects.none};
         case "GetWeatherData": var _p1 = _p0._0;
           var weather = model.weather;
           var w = A2($Maybe.withDefault,weather,_p1);
           var newWeather = _U.update(weather,{temp: w.temp,sunrise: w.sunrise,sunset: w.sunset,name: w.name});
           var d = A2($Debug.log,"weather",_p1);
           return {ctor: "_Tuple2",_0: _U.update(model,{weather: newWeather}),_1: $Effects.none};
         case "GetFroodleData": var _p2 = _p0._0;
           var froodle = model.froodle;
           var newFroodle = A2($Maybe.withDefault,froodle,_p2);
           var d = A2($Debug.log,"froodle",_p2);
           return {ctor: "_Tuple2",_0: _U.update(model,{froodle: newFroodle}),_1: $Effects.none};
         default: var _p3 = _p0._0;
           var birthdays = model.birthdays;
           var newBirthdays = A2($Maybe.withDefault,birthdays,_p3);
           var d = A2($Debug.log,"froodle birthdays",_p3);
           return {ctor: "_Tuple2",_0: _U.update(model,{birthdays: newBirthdays}),_1: $Effects.none};}
   });
   var GetFroodleBirthdayData = function (a) {    return {ctor: "GetFroodleBirthdayData",_0: a};};
   var GetFroodleData = function (a) {    return {ctor: "GetFroodleData",_0: a};};
   var GetWeatherData = function (a) {    return {ctor: "GetWeatherData",_0: a};};
   var UpdateTime = function (a) {    return {ctor: "UpdateTime",_0: a};};
   var Run = function (a) {    return {ctor: "Run",_0: a};};
   var NoOp = {ctor: "NoOp"};
   return _elm.Elm.Actions.values = {_op: _op
                                    ,NoOp: NoOp
                                    ,Run: Run
                                    ,UpdateTime: UpdateTime
                                    ,GetWeatherData: GetWeatherData
                                    ,GetFroodleData: GetFroodleData
                                    ,GetFroodleBirthdayData: GetFroodleBirthdayData
                                    ,update: update};
};
Elm.Elm = Elm.Elm || {};
Elm.Elm.Elements = Elm.Elm.Elements || {};
Elm.Elm.Elements.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Elements = _elm.Elm.Elements || {};
   if (_elm.Elm.Elements.values) return _elm.Elm.Elements.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var widget = $Html.div(_U.list([$Html$Attributes.$class("widget")]));
   var gContainer = $Html.div(_U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "100%"}]))]));
   var col = function (number) {
      var className = A2($Basics._op["++"],"col col-xs-",$Basics.toString(number));
      return $Html.div(_U.list([$Html$Attributes.$class(className)]));
   };
   var bottom = $Html.div(_U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                                                  ,{ctor: "_Tuple2",_0: "bottom",_1: "0"}
                                                                  ,{ctor: "_Tuple2",_0: "width",_1: "100%"}]))]));
   var row = $Html.div(_U.list([$Html$Attributes.$class("row")]));
   return _elm.Elm.Elements.values = {_op: _op,row: row,bottom: bottom,col: col,gContainer: gContainer,widget: widget};
};
Elm.Elm = Elm.Elm || {};
Elm.Elm.Tasks = Elm.Elm.Tasks || {};
Elm.Elm.Tasks.Ajax = Elm.Elm.Tasks.Ajax || {};
Elm.Elm.Tasks.Ajax.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Tasks = _elm.Elm.Tasks || {};
   _elm.Elm.Tasks.Ajax = _elm.Elm.Tasks.Ajax || {};
   if (_elm.Elm.Tasks.Ajax.values) return _elm.Elm.Tasks.Ajax.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var getString = F2(function (url,action) {    return $Effects.task(A2($Task.map,action,$Task.toMaybe($Http.getString(url))));});
   var get = F3(function (url,decoder,action) {    return $Effects.task(A2($Task.map,action,$Task.toMaybe(A2($Http.get,decoder,url))));});
   return _elm.Elm.Tasks.Ajax.values = {_op: _op,get: get,getString: getString};
};
Elm.Elm = Elm.Elm || {};
Elm.Elm.Time = Elm.Elm.Time || {};
Elm.Elm.Time.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Time = _elm.Elm.Time || {};
   if (_elm.Elm.Time.values) return _elm.Elm.Time.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var leadingZero = function (number) {    return _U.cmp(number,10) < 0 ? A2($Basics._op["++"],"0",$Basics.toString(number)) : $Basics.toString(number);};
   ...
   var germanDayOfWeek = function (dayOfWeek) {
      var _p1 = dayOfWeek;
      switch (_p1.ctor)
   ...
   var currentMonth = function (t) {    var date$ = $Date.fromTime(t);var month$ = monthToNumber($Date.month(date$));return month$;};
   var currentDate = function (t) {
      var date$ = $Date.fromTime(t);
      var day$ = $Basics.toString($Date.day(date$));
      var dayOfWeek = germanDayOfWeek($Date.dayOfWeek(date$));
      var month$ = $Basics.toString(monthToNumber($Date.month(date$)));
      var year$ = leadingZero($Date.year(date$));
      var now = A2($Basics._op["++"],
      dayOfWeek,
      A2($Basics._op["++"],", ",A2($Basics._op["++"],day$,A2($Basics._op["++"],".",A2($Basics._op["++"],month$,A2($Basics._op["++"],".",year$))))));
      return now;
   };
   ...
   var currentSalutation = function (t) {
      var date$ = $Date.fromTime(t);
      var hour$ = $Date.hour(date$);
      var dt = toDayTime(hour$);
      var _p2 = dt;
      switch (_p2.ctor)
      {case "Morning": return "Guten Mittag";
         case "Lunch": return "Guten Mittag";
         case "Afternoon": return "Guten Nachmittag";
         case "Evening": return "Guten Abend";
         default: return "Gute Nacht";}
   };
   var getCurrentTime = $Effects.task(A2($Task.map,$Elm$Actions.UpdateTime,$TaskTutorial.getCurrentTime));
   var updateCurrentTime = function (t) {    return $Elm$Actions.UpdateTime(t);};
   var timeInput = A2($Signal.map,updateCurrentTime,$Time.every($Time.second));
   var htmlList = function (model) {
      var _p3 = model.time;
      if (_p3 === 0.0) {
            return _U.list([$Html.text("")]);
         } else {
            return _U.list([A2($Html.div,_U.list([]),_U.list([$Html.text(currentDate(model.time))]))
                           ,A2($Html.div,_U.list([]),_U.list([$Html.text(currentTime(model.time))]))
                           ,A2($Html.br,_U.list([]),_U.list([]))
                           ,A2($Html.div,_U.list([]),_U.list([$Html.text(currentSalutation(model.time))]))]);
         }
   };
   var time = function (model) {    return $Elm$Elements.widget(htmlList(model));};
   return _elm.Elm.Time.values = {_op: _op
                                 ,time: time
                                 ,htmlList: htmlList
                                 ,timeInput: timeInput
                                 ...
                                 ,Night: Night
                                 ,toDayTime: toDayTime
                                 ,currentSalutation: currentSalutation
                                 ,currentTime: currentTime
                                 ,currentDate: currentDate
                                 ,currentMonth: currentMonth
                                 ,germanDayOfWeek: germanDayOfWeek
                                 ,monthToNumber: monthToNumber
                                 ,leadingZero: leadingZero};
};
Elm.Elm = Elm.Elm || {};
Elm.Elm.Birthdays = Elm.Elm.Birthdays || {};
Elm.Elm.Birthdays.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Birthdays = _elm.Elm.Birthdays || {};
   if (_elm.Elm.Birthdays.values) return _elm.Elm.Birthdays.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Elm$Actions = Elm.Elm.Actions.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var getUrl = "http://fleidlof.alnilam.uberspace.de/nodejs/froodle/api/v1/Tasks/56d695a0605e4d52509df221.md?shared=true";
   var getBirthdays = A2($Elm$Tasks$Ajax.getString,getUrl,$Elm$Actions.GetFroodleBirthdayData);
   var updateBirthdays = function (t) {    return $Elm$Actions.Run(getBirthdays);};
   var birthdaysInput = A2($Signal.map,updateBirthdays,$Time.every($Time.hour * 12));
   var birthdays = function (model) {    return A2($Html.div,_U.list([]),_U.list([$Markdown.toHtml(model.birthdays)]));};
   return _elm.Elm.Birthdays.values = {_op: _op
                                      ,birthdays: birthdays
                                      ,birthdaysInput: birthdaysInput
                                      ,updateBirthdays: updateBirthdays
                                      ,getBirthdays: getBirthdays
                                      ,getUrl: getUrl};
};
Elm.Elm = Elm.Elm || {};
Elm.Elm.Froodle = Elm.Elm.Froodle || {};
Elm.Elm.Froodle.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Froodle = _elm.Elm.Froodle || {};
   if (_elm.Elm.Froodle.values) return _elm.Elm.Froodle.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Elm$Actions = Elm.Elm.Actions.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var froodleData = A2($Json$Decode.at,_U.list(["froodle"]),$Json$Decode.string);
   var getFroodle = A3($Elm$Tasks$Ajax.get,
   "https://fleidlof.alnilam.uberspace.de/nodejs/froodle/api/v1/Tasks/56f07d98b5dd41487146d4c2.md?shared=true",
   froodleData,
   $Elm$Actions.GetFroodleData);
   var updateFroodle = function (t) {    return $Elm$Actions.Run(getFroodle);};
   var froodleInput = A2($Signal.map,updateFroodle,$Time.every($Time.minute * 10));
   var froodle = function (model) {    return $Elm$Elements.widget(_U.list([$Markdown.toHtml(model.froodle)]));};
   return _elm.Elm.Froodle.values = {_op: _op
                                    ,froodle: froodle
                                    ,froodleInput: froodleInput
                                    ,updateFroodle: updateFroodle
                                    ,getFroodle: getFroodle
                                    ,froodleData: froodleData};
};
Elm.Elm = Elm.Elm || {};
...
Elm.Elm.Weather.make = function (_elm) {
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var weatherData = A5($Json$Decode.object4,
   $Elm$Model.Weather,
   ...
   A2($Json$Decode.at,_U.list(["name"]),$Json$Decode.string));
   ...
   weatherData,
   $Elm$Actions.GetWeatherData);
   var updateWeather = function (t) {    return $Elm$Actions.Run(getWeather);};
   var weatherInput = A2($Signal.map,updateWeather,$Time.every($Time.hour));
   var kelvinToCelsius = function (t) {    return $Basics.round(t - 273.15);};
   var htmlList = function (model) {
      var _p0 = model.weather.temp;
      if (_p0 === 0.0) {
            return _U.list([]);
         } else {
            return _U.list([$Html.text("Temperatur: ")
                           ...
                           ,A2($Html.br,_U.list([]),_U.list([]))
                           ,$Html.text(model.weather.name)]);
         }
   };
   var weather = function (model) {    return $Elm$Elements.widget(htmlList(model));};
   return _elm.Elm.Weather.values = {_op: _op
                                    ,weather: weather
                                    ,htmlList: htmlList
...
Elm.Elm = Elm.Elm || {};
Elm.Elm.Init = Elm.Elm.Init || {};
Elm.Elm.Init.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Init = _elm.Elm.Init || {};
   if (_elm.Elm.Init.values) return _elm.Elm.Init.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Elm$Birthdays = Elm.Elm.Birthdays.make(_elm),
   $Elm$Froodle = Elm.Elm.Froodle.make(_elm),
   $Elm$Model = Elm.Elm.Model.make(_elm),
   $Elm$Time = Elm.Elm.Time.make(_elm),
   ...
   var init = {ctor: "_Tuple2"
              ,_0: $Elm$Model.model
              ,_1: $Effects.batch(_U.list([$Elm$Weather.getWeather,$Elm$Froodle.getFroodle,$Elm$Birthdays.getBirthdays,$Elm$Time.getCurrentTime]))};
...
Elm.Elm.View.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.View = _elm.Elm.View || {};
   if (_elm.Elm.View.values) return _elm.Elm.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Elm$Actions = Elm.Elm.Actions.make(_elm),
   ...
   var view = F2(function (address,model) {
      return $Elm$Elements.gContainer(_U.list([$Elm$Elements.row(_U.list([A2($Elm$Elements.col,6,_U.list([$Elm$Weather.weather(model)]))
                                              ...
                                              ,$Elm$Elements.bottom(_U.list([$Elm$Elements.row(_U.list([A2($Elm$Elements.col,
                                                                                                       6,
                                                                                                       _U.list([$Elm$Birthdays.birthdays(model)]))
                                                                                                       ,A2($Elm$Elements.col,
                                                                                                       6,
                                                                                                       _U.list([$Elm$Froodle.froodle(model)]))]))]))]));
   });
...
Elm.Main.make = function (_elm) {
   ...
   $Elm$Actions = Elm.Elm.Actions.make(_elm),
   $Elm$Froodle = Elm.Elm.Froodle.make(_elm),
   $Elm$Init = Elm.Elm.Init.make(_elm),
   $Elm$Time = Elm.Elm.Time.make(_elm),
   $Elm$View = Elm.Elm.View.make(_elm),
   $Elm$Weather = Elm.Elm.Weather.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $Elm$Init.init
                             ,view: $Elm$View.view
                             ,update: $Elm$Actions.update
                             ,inputs: _U.list([$Elm$Time.timeInput,$Elm$Weather.weatherInput,$Elm$Froodle.froodleInput])});
   var main = app.html;
