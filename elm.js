...
Elm.Elm.Init.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var init = {ctor: "_Tuple2",_0: $Elm$Model.model,_1: $Effects.none};
   return _elm.Elm.Init.values = {_op: _op,init: init};
};
Elm.Elm = Elm.Elm || {};
Elm.Elm.Reversinator = Elm.Elm.Reversinator || {};
Elm.Elm.Reversinator.make = function (_elm) {
   "use strict";
   _elm.Elm = _elm.Elm || {};
   _elm.Elm.Reversinator = _elm.Elm.Reversinator || {};
   if (_elm.Elm.Reversinator.values) return _elm.Elm.Reversinator.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Elm$Actions = Elm.Elm.Actions.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var reverseText = function (model) {
      var log = A2($Debug.watch,"col",model.text);
      var _p0 = model.reverse;
      if (_p0 === true) {
            return $Html.text($String.reverse(model.text));
         } else {
            return $Html.text(model.text);
         }
   };
   var reversinator = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.div,
              ...
              _U.list([$Html$Attributes.type$("text")
                      ...
                      function (_p1) {
                         return A2($Signal.message,address,$Elm$Actions.UpdateString(_p1));
                      })]),
              _U.list([]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("form-group")]),
              ...
              _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.type$("checkbox")
                              ,$Html$Attributes.checked(model.reverse)
                              ,A3($Html$Events.on,
                              "change",
                              $Html$Events.targetChecked,
                              function (_p2) {
                                 return A2($Signal.message,address,$Elm$Actions.UpdateReverse(_p2));
                              })]),
                      _U.list([]))
                      ,$Html.text("reverse?")]))]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("form-group")]),_U.list([reverseText(model)]))]));
   });
   return _elm.Elm.Reversinator.values = {_op: _op,reverseText: reverseText,reversinator: reversinator};
};
Elm.Elm = Elm.Elm || {};
...
Elm.Elm.View.make = function (_elm) {
   ...
   $Elm$Model = Elm.Elm.Model.make(_elm),
   $Elm$Reversinator = Elm.Elm.Reversinator.make(_elm),
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([$Elm$Elements.gContainer(_U.list([$Elm$Elements.row(_U.list([A2($Elm$Elements.col,6,_U.list([$Html.text("weather")]))
                                                ...
                                                ,$Elm$Elements.bottom(_U.list([$Elm$Elements.row(_U.list([A2($Elm$Elements.col,
                                                                                                         ...
                                                                                                         ,A2($Elm$Elements.col,
                                                                                                         6,
                                                                                                         _U.list([A2($Elm$Reversinator.reversinator,
                                                                                                         address,
                                                                                                         model)]))]))]))]))]));
   });
...
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $Elm$Init.init,view: $Elm$View.view,update: $Elm$Actions.update,inputs: _U.list([$Elm$Time.timeInput])});
   var main = app.html;
